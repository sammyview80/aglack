 ...
 * prefers-color-scheme. Applied on <html data-theme> so Radix portals
 * (dialogs, menus) inherit the same tokens as the shell.
 *
 * Callers: App.tsx, Sidebar.tsx, Dashboard.tsx. Boot script in index.html
 * sets the attribute before paint to avoid a flash.
 */
